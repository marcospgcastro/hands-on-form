...
const Card = () => {
  return (
    <CardContainer>
      ...
      <Content>
        <UserInfo>
          <UserPicture src="https://avatars.githubusercontent.com/u/23128572?v=4"/>
         <div>
          <h4>Marcos Paulo</h4>
          <p>Há 10 minutos</p>
        </div> 
        ...
        <PostInfo>
          <h4>Projeto para curso de Reactjs e React Native </h4>
          <p>Projeto feito no curso de ReactJs da Digital Innovation One...<strong>Saiba Mais</strong></p>
        </PostInfo>
        <HasInfo>
          <h4>#ReactJs #ReactNative #NodeJs #JavaScript</h4>
          <p>
            <FiThumbsUp />5
          </p>
        </HasInfo>
